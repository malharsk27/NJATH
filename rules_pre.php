    ...
    <body>
        ...
        <div id="rules-content">
            ...
            <ol id="rules-list">
                ...
                <li> <p>Each player starts off with a score of 40. The questions are categorized by the difficulty level. </p> </li>
                <li> <p>You will have to pay score costs for opening questions so choose wisely! </p> </li>
                <li> <p>Your profile page will contain a list of all questions of a level, each highlighted differently - unopened in blue, opened in yellow and solved in green.</p></li>
                ...
                <li> <p>Event starts from 17:00 hrs Friday i.e 9th Oct 15 and finishes at 17:00 hrs Sunday i.e 10th Oct 15.</p> </li>
            </ol>
        </div>
    </body>
</html>