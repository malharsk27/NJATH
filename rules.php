    ...
    <body>
        ...
        <div id="rules-content">
            ...
            <ol id="rules-list">
                ...
                <li> <p> Only answers as alpha-numeric characters in lower case (a-z, 0-9) are allowed. e.g. Suppose your answer is “I Love NJATH1234”, then write it as “ilovenjath123”. In case of dates like 31st Jan 2016, write 31012016. </p> </li> 
